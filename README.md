...
The drawing record results are extracted from the official pdf results file and are kept in a file named `draws.txt`. New results are added to end of that file in draw date order.
